    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#" (click)="setActiveTab('dashboard')">
          ...
          <div class="sidebar-brand-text mx-3">Stock Prediction <sup>v3.6.0</sup></div>
        </a>
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; Stock Prediction Dashboard v3.6.0 2025 - Powered by SB Admin 2</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
...
export class AppComponent implements OnInit {
  title = 'Stock Prediction Dashboard v3.6.0';
  activeTab = 'dashboard';
  searchSymbol = '';
  alertCount = 3;
  messageCount = 1;
